...
export declare namespace CarbonTheme {
    interface Config {
        /**
    ...
    type SocialLinkIcon = 'discord' | 'facebook' | 'github' | 'instagram' | 'linkedin' | 'mastodon' | 'npm' | 'slack' | 'twitter' | 'x' | 'youtube' | {
        svg: string;
    };
    interface Footer {
        message?: string;
