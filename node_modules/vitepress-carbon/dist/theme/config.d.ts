...
export interface ThemeConfig {
    ...
    search?: {
        provider: 'local';
        options?: CarbonTheme.LocalSearchOptions;
    } | {
        provider: 'algolia';
        options: CarbonTheme.AlgoliaSearchOptions;
    };
    /**
...
export type SocialLinkIcon = 'discord' | 'facebook' | 'github' | 'instagram' | 'linkedin' | 'mastodon' | 'npm' | 'slack' | 'twitter' | 'x' | 'youtube' | {
    svg: string;
};
